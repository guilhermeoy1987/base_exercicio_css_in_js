...
const ListaVagas = () => {
  ...
  // Filtro que ignora maiúsculas e minúsculas
  const vagasFiltradas = vagas.filter(
    (x) => x.titulo.toLocaleLowerCase().includes(filtro.toLocaleLowerCase())
  )
    ...
    <Container>
      ...
      <Vacancies>
        {vagasFiltradas.map((vag) => (
          <VagaComponente // 2. NOME IGUAL AO DO IMPORT E SEM O "S" NO FINAL
            key={vag.id}
            titulo={vag.titulo}
